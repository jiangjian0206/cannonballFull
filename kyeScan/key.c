...
void KeyServe(void)
{
  ...
  if(G_TimerCnt_KeyServe_10MS >=10)
	...
	//key2  进
	if( ReadKey_Down_01 && ReadKey_Down_02 && ReadRoute_up_01 )Key2.TimeCnt_Key_Down>250?Key2.TimeCnt_Key_Down=200:Key2.TimeCnt_Key_Down++;
			else Key2.TimeCnt_Key_Down =0;
	if(ReadKey_Up_01 && ReadKey_Up_02) Key2.TimeCnt_Key_Up >250?Key2.TimeCnt_Key_Up =200:Key2.TimeCnt_Key_Up++;
